...
<div class="navitagorDiv">
	<nav class="navbar navbar-default navbar-fixed-top navbar-inverse">
		...
		<a class="navbar-brand" href="${pageContext.request.contextPath }/Categorylist/1">分类管理</a>
		<a class="navbar-brand" href="${pageContext.request.contextPath }/Userlist/1">用户管理</a>
